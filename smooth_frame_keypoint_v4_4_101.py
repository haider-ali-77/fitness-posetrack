...
def main(args):
    ...
    if args.input_type == 'video':
        ...
        # new generate_frame
        generate_frames = 'ffmpeg -i ' + str(args.video_path)+' -r '+str(args.input_fps) + ' -qscale:v 2 ' + video_frame_path + '/%d.' + args.image_ext
        #
        ...
        # face bluring
        # blur = FaceBlurring()
        # blur.start_face_blurring(video_frame_path,video_frame_path)
...
# print(umax)
    ...
    if (int(args.output_option) == 4):
        ...
        if alignment == "back_side":
            ...
            seq_point_dict = front_back_optimal_keypoints(all_back_right_knee_leg_angle, all_back_left_knee_leg_angle,
                                                          ...
                                                          all_back_left_knee_hip_vertical,
                                                          all_back_left_hip_right_hip, all_back_trunk_lean,
                                                          optimal_rightfoot_on_ground_max_femour,
                                                          img_rightfoot_ground_max_femour,
                                                          'Phase_Dectection_backview_right_max_femour', args.image_ext,
                                                          args.pelvis, alignment, 'right_femour')
            ...
            seq_point_dict = front_back_optimal_keypoints(all_back_right_knee_leg_angle, all_back_left_knee_leg_angle,
                                                          ...
                                                          all_back_left_knee_hip_vertical,
                                                          all_back_left_hip_right_hip, all_back_trunk_lean,
                                                          optimal_leftfoot_on_ground_max_femour,
                                                          img_leftfoot_ground_max_femour,
                                                          'Phase_Dectection_backview_left_max_femour', args.image_ext,
                                                          args.pelvis, alignment, 'left_femour')
            seq_list.append(seq_point_dict)
            # optimal_frame_seq_list.append(seq_point_dict)
        ...
        if alignment == "front_side":
            ...
            seq_point_dict = front_back_optimal_keypoints(all_front_right_knee_leg_angle, all_front_left_knee_leg_angle,
                                                          ...
                                                          optimal_rightfoot_on_ground_max_femour,
                                                          img_rightfoot_ground_max_femour,
                                                          'Phase_Dectection_frontview_right_max_femour', args.image_ext,
                                                          args.pelvis, alignment, 'right_femour')
            seq_list.append(seq_point_dict)
            # optimal_frame_seq_list.append(seq_point_dict)
            ...
            if args.pelvis == 'on':
                ...
                seq_point_dict = front_back_optimal_keypoints(all_front_right_knee_leg_angle,
                                                              ...
                                                              optimal_rightfoot_on_ground_pelvis_drop,
                                                              img_rightfoot_ground_pelvis_drop,
                                                              'Phase_Dectection_frontview_pelvis_angle', args.image_ext,
            ...
            seq_point_dict = front_back_optimal_keypoints(all_front_right_knee_leg_angle, all_front_left_knee_leg_angle,
                                                          ...
                                                          all_front_left_knee_hip_vertical,
                                                          all_front_left_hip_right_hip, all_front_trunk_lean,
                                                          optimal_leftfoot_on_ground_max__femour,
                                                          img_leftfoot_ground_max_femour,
                                                          'Phase_Dectection_frontview_left_max_femour', args.image_ext,
                                                          args.pelvis, alignment, 'left_femour')
            seq_list.append(seq_point_dict)
            # optimal_frame_seq_list.append(seq_point_dict)
            ...
            #                    'Phase_Dectection_frontview_right_max_femour_')
            ...
            #                    'Phase_Dectection_frontview_left_max_femour_')
    ...
    if (int(args.output_option) == 3 or int(args.output_option) == 4):
        # print("Output option = ", args.output_option)
        #print("first if option 3")
        cpoy_left_video_shell_script = 'cp -r' + out_put_image_dir + '/left/movie/*.mp4 ' + args.output_dir + '/'
        cpoy_right_video_shell_script = 'cp -r' + out_put_image_dir + \
                                        '/right/movie/*.mp4 ' + args.output_dir + '/'
        cpoy_json_shell_script = 'cp ' + out_put_image_dir + '/*.json ' + args.output_dir + '/'
        ...
        if alignment == "front_side":
            ...
            copy_merged_images_shell_script = 'cp -r' + out_put_image_dir + \
    ...
    if (int(args.output_option) == 3 ):
        if alignment == "back_side" or alignment == "front_side":
            remove_both_images = 'rm -rf ' + out_put_image_dir + 'both_side/'
            os.system(remove_both_images)
        if alignment == "right_side" or alignment == "left_side":
            remove_processed_images_folder_script = 'rm -rf ' + args.output_dir + '/Processed_frames_*'
